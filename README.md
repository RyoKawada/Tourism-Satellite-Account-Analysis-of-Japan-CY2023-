...
GVA (Gross Value Added) represents the value created by each industry, and TourismGDP is the sum of GVA across all industries.
...
![Tourism GDP by Industry](tourism_gdp_by_industry.png)
